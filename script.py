...
driver.get("https://www.referendum.interieur.gouv.fr/consultation_publique/8/A")
...
#         EC.presence_of_element_located((By. ,"rc-anchor"))
#         ) 
wait_between(10.5, 12.7)  
CheckBox = driver.find_elements_by_class_name("rc-anchor")[0]
